...
<body>
    <header>
        ...
        <div>
            <img id="imgUser" class="imgUser" src="img/usuario.jfif" alt="" srcset="">
    ...
    <main>
        <aside>
            <ul>
                ...
                <li><i class="fa-solid fa-file-invoice-dollar"></i>Facturas</li>
                <li><i class="fa-solid fa-circle-exclamation"></i>Incidencias</li>
                <li><i class="fa-regular fa-calendar"></i>Calendario</li>
